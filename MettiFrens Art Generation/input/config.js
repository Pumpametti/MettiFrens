...
const description = "MettiFrens is an NFT test collection to show artists how to create NFT collections with a generative minting process. MettiFren will not be in official art collections of Pumpametti, maybe they have educational historical relic effect, who knows.";
// base url to use in metadata file
const baseImageUri = "leave this one for now";
...
let rarityWeights = [
  addRarity('super_rare', 90, 100),
  addRarity('rare', 70, 90),
  addRarity('original', 1, 70)
];
...
addRarityPercentForLayer('original', 'BACKGROUND', { 'original': 55.5, 'rare': 36.0, 'super_rare': 8.5 });
addRarityPercentForLayer('original', 'FIGURE', { 'original': 55.5, 'rare': 36.0, 'super_rare': 8.5 });

addRarityPercentForLayer('rare', 'BACKGROUND', { 'original': 55.5, 'rare': 36.0, 'super_rare': 8.5 });
addRarityPercentForLayer('rare', 'FIGURE', { 'original': 55.5, 'rare': 36.0, 'super_rare': 8.5 });

addRarityPercentForLayer('super_rare', 'BACKGROUND', { 'original': 55.5, 'rare': 36.0, 'super_rare': 8.5 });
addRarityPercentForLayer('super_rare', 'FIGURE', { 'original': 55.5, 'rare': 36.0, 'super_rare': 8.5 });
